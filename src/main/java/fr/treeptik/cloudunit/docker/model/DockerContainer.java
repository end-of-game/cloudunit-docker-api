...
public class DockerContainer {
    ...
    private static DockerContainerJSON dockerContainerJSON = new DockerContainerJSON();
    ...
    /**
     *
     * @param containerPort_protocol : container protocol
     * @param hostIP : ip host
     * @param hostPort : port host
     */
